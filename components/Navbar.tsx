...
const Navbar = () => {
    return (
        <>
            {/* Desktop View */}
            <header className="sticky top-0 w-full bg-yellow-600 p-3 flex flex-row items-center justify-center text-gray-200 supports-backdrop-filter:bg-yellow-600/80 backdrop-blur z-50">

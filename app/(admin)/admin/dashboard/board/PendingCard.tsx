...
export default function PendingCard({ booking, onForceVerify }: PendingCardProps) {
    return (
        <div className="flex flex-col border border-dashed border-gray-300 bg-yellow-400/10">

            <div className="py-4 px-2 rounded-md relative transition-all hover:shadow-md">
            ...
            <div className="flex items-center gap-3 mb-3 pb-3 border-b border-gray-100 mt-1 ml-3">
                {booking.carDetails?.imageUrl ? (
                    ...
                    <div className="w-10 h-10 bg-gray-100 rounded-full animate-pulse border border-gray-200" />
                        ...
                        <div className="space-y-1">
                            <p className="text-sm font-semibold text-gray-800">Name: {booking.fullName}</p>
                            <p className="text-xs text-gray-500">Email: {booking.email}</p>
